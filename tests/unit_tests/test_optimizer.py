...
def test_tag_muon_split_qkv_parameters_tags_standard_qkv():
    ...
    assert qkv_weight.muon_split_shapes == (64, 16, 16)
...
def test_tag_muon_split_qkv_parameters_tags_mla_up_projections():
    ...
    params = dict(model.named_parameters())
    assert params['self_attention.linear_q_proj.weight'].muon_split_shapes == (32, 8)
    assert params['self_attention.linear_q_up_proj.weight'].muon_split_shapes == (32, 8)
    assert params['self_attention.linear_kv_up_proj.weight'].muon_split_shapes == (32, 24)
...
def test_tag_muon_split_qkv_parameters_skips_mla_down_projections():
    ...
    params = dict(model.named_parameters())
    assert not hasattr(params['self_attention.linear_q_down_proj.weight'], 'muon_split_shapes')
    assert not hasattr(params['self_attention.linear_kv_down_proj.weight'], 'muon_split_shapes')
    assert not hasattr(params['self_attention.linear_qkv_down_proj.weight'], 'muon_split_shapes')
